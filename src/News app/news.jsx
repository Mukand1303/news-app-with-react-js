...
function News() {
  ...
  useEffect(() => {
    fetch(
      `https://newsapi.org/v2/everything?q=world&from=${date}&sortBy=publishedAt&apiKey=48793f2c226b49caa31afe8b1cdd9ea0`
    )
  ...
  async function getNews() {
    try {
      const response = await fetch(
        `https://newsapi.org/v2/everything?q=${input}&from=${date}&sortBy=publishedAt&apiKey=48793f2c226b49caa31afe8b1cdd9ea0`
      );
          ...
          {typeof newsData.articles !== "undefined" ? (
            <div className="firts-news">
              <div className="news-img">
                <a target="blank" href={newsData.articles[0].url}>
                  <img src={newsData.articles[0].urlToImage} alt="" />
                </a>
              </div>
